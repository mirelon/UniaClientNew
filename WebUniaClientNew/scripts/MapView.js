...
var ViewMap = {
    ...
    initialize: function (el) {
        ...
        $('<!--<button data-route="orders" class="icon ico_back">&nbsp;</button>--><div class="page-header"><a href="#" class="deploy-sidebar"></a></div></div><div class="bxslider-wrapper" data-snap-ignore="true"><div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 306px;"><div class="bxslider" style="width: 215%; position: relative; -webkit-transition: 0s; transition: 0s; -webkit-transform: translate3d(-1351px, 0px, 0px);"><div style="float: left; list-style: none; position: relative; width: 1351px;" class="bx-clone"><a href="order.php"></a><p align="center"><a href="order.php" class="order"><img src="images/order.png" width="100%"></a></p><blockquote class="slider-caption"><p class="slider-title">TAXI 16158</p></blockquote></div><div style="float: left; list-style: none; position: relative; width: 1351px;"><a href="order.php"></a><p align="center"><a href="order.php" class="order"><img src="images/order.png" width="100%"></a></p><blockquote class="slider-caption"><p class="slider-title">TAXI 16158</p></blockquote></div><div style="float: left; list-style: none; position: relative; width: 1351px;" class="bx-clone"><a href="order.php"></a><p align="center"><a href="order.php"><img src="images/order.png" width="100%"></a></p><blockquote class="slider-caption"><p class="slider-title">TAXI 16158</p></blockquote></div></div></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div></div>').appendTo(header);        
