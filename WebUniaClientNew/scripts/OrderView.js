...
$('.page-header').css('display', 'none');
    ...
    this.render = function () {
        var self = this;console.log($("#orderSave").html());
        //this.el.html(OrderView.template());
        $("body").on('click', '#orderSave', function (e) { e.preventDefault();console.log('try save');if (!$(this).hasClass("transparent")) self.save(); });
    ...
    this.save = function () {console.log('save');
        var self = this;
    ...
    this.showForm = function () {
            ...
            //$("#orderForm fieldset").hide();
            //$("#" + (this.order.step)).show();
            $('#fTaxiCompany, #fOrderSave, #fOrderOk, #fOrderError').hide();
            $("#orderForm").show();
