var app = {
    ...
    registerEvents: function () {
        ...
        $('body').on('click', '[data-route]', function (e) { e.preventDefault(); app.route($(this).attr("data-route")); });
        $('body').on('click', '#newOrder, .order', function (e) { e.preventDefault(); Service.newOrder(); });
